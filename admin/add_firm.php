                ...
                <div class="col-xl-6 col-xxl-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Firm</h4>
                        </div>
                        <hr>
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="firm_insert.php" enctype="multipart/form-data">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Image <span class="text-primary">(Resolution:300 × 208)</span></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control mt-3" name="firm_type" id="type" required>
                                                <option value="" disabled selected>Select</option>
                                                <option value="ALL">ALL</option>
                                                <option value="FARM-GALLERY">FARM GALLERY</option>
