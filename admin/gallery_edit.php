...
include '../db_con.php';
$que = "SELECT * FROM add_gallery WHERE id = $user_id";
...
<head>
    ...
    <title>Vanasthali Georup | Admin Dashboard </title>
    <!-- Favicon icon -->
                            ...
                            <form method="POST" action="gallery_update.php" enctype="multipart/form-data">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="gallery_type" id="type" required>
                                                <option value="" disabled>Select</option>
                                                <option value="All" <?php echo ($row['gallery_type'] == 'All') ? 'selected' : ''; ?>>ALL</option>
                                                <option value="TEAM" <?php echo ($row['gallery_type'] == 'TEAM') ? 'selected' : ''; ?>>TEAM</option>
                                                <option value="OUR-SITE" <?php echo ($row['gallery_type'] == 'OUR-SITE') ? 'selected' : ''; ?>>OUR-SITE</option>
