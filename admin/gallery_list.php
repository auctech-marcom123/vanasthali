                            ...
                            <div class="table-responsive">
                                <table id="example" class="table header-border table-responsive-sm table-bordered"
                                    ...
                                    <tbody>
                                        ...
                                        $sel_que = "SELECT * FROM add_gallery"; // Fetch all projects
                                        $res = mysqli_query($con, $sel_que);
                                        $i = 1;
                                        while ($row = mysqli_fetch_array($res)) {
                                
                                            // Fetch project image
                                            $image_query = "SELECT * FROM gallery_images WHERE gallery_type_id = '$row[id]' LIMIT 1";
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><img src="gallery_uploads/<?php echo $image_path; ?>" alt="Image"
                                            ...
                                            <td>
                                                <a type="submit" class="btn btn-primary shadow btn-xs sharp me-1"
                                                    href="gallery_edit.php?user_id=<?php echo $row['id']; ?>"
                                                    style="color:white;">
