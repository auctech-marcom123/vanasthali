...
include '../db_con.php';
$que = "SELECT * FROM add_firm WHERE id = $user_id";
                ...
                <div class="col-xl-6 col-xxl-12 col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Update Firm</h4>
                        </div>
                        <hr>
                        <div class="card-body">
                            <div class="basic-form">
                            <form method="POST" action="firm_update.php" enctype="multipart/form-data">
                                    <div class="form-row">
                                       
                                        <div class="form-group col-md-6">
                                            <label>Choose as</label>
                                            <select class="form-control" name="firm_type" id="type" required>
                                                <option value="" disabled>Select</option>
                                                <option value="ALL" <?php echo ($row['firm_type'] == 'ALL') ? 'selected' : ''; ?>>ALL</option>
                                                <option value="FARM-GALLERY" <?php echo ($row['firm_type'] == 'FARM-GALLERY') ? 'selected' : ''; ?>>FARM GALLERY</option>
                                                <option value="OUR-AMENITIES" <?php echo ($row['firm_type'] == 'OUR-AMENITIES') ? 'selected' : ''; ?>>OUR AMENITIES</option>
