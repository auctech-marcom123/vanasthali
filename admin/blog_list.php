                            ...
                            <div class="table-responsive">
                                <table id="example" class="table header-border table-responsive-sm table-bordered"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><img src="../blog/blog_uploads/<?php echo $image_path; ?>" alt="Image"
                                            ...
                                            <td>
                                                <a type="submit" class="btn btn-primary shadow btn-xs sharp me-1"
                                                    href="blog_edit.php?user_id=<?php echo $row['id']; ?>"
                                                    style="color:white;">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <form method="POST" action="blog_dlt.php" style="display:inline;">
