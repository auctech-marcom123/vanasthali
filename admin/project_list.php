                                ...
                                <table id="example" class="table header-border table-responsive-sm table-bordered"
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($res)) {
                                            ...
                                            // Fetch project image
                                            $image_query = "SELECT * FROM project_images WHERE project_type_id = '$row[id]' LIMIT 1";
                                        ...
                                        <tr>
                                            <td><?php echo $i; ?></td>
                                            <td><img src="project_uploads/<?php echo $image_path; ?>" alt="Image" class="img-thumbnail" style="max-width: 80px; height: auto;"></td>
                                            <td><?php echo $row['project_type']; ?></td>
                                            <td><?php echo $row['heading']; ?></td>
                                            <td>
                                                <a type="submit" class="btn btn-primary shadow btn-xs sharp me-1"
                                                    href="project_edit.php?user_id=<?php echo $row['id']; ?>" style="color:white;">
